...
// //   const userRole = localStorage.getItem('userRole') || 'PHOTOGRAPHER';
// //   const token = localStorage.getItem('token');

// //   // Fetch all campus events from backend
// //   const fetchEvents = async () => {
// //     try {
// //       const res = await fetch('http://localhost:5000/api/events'); // Apne events route ke hisab se modify kar lena agar port alag ho
// //       const data = await res.json();
// //       if (Array.isArray(data)) {
// //         setEvents(data);
// //       } else {
// //         // Fallback mock agar backend events empty ho database mein
// //         setEvents([
// //           { id: '9696a525-fcc6-43c7-8a8b-3f76b9307425', name: 'Annual Cultural Fest 2026', description: 'The flagship cultural event containing dances, concerts, and stalls.', category: 'CULTURAL FEST', createdAt: '2026-05-31' }
// //         ]);
// //       }
// //     } catch (err) {
// //       console.error("Error fetching events:", err);
// //       // Hardcoded fallback logic to keep workspace clean
// //       setEvents([
// //         { id: '9696a525-fcc6-43c7-8a8b-3f76b9307425', name: 'Annual Cultural Fest 2026', description: 'The flagship cultural event containing dances, concerts, and stalls.', category: 'CULTURAL FEST', createdAt: '2026-05-31' }
// //       ]);
// //     }
...
// //         fetchEvents(); // Reload live list stream
// //       } else {
...
// //         {/* 🔥 NEW FEATURE: METRICS & COMMAND SYSTEM */}
...
// //             <h3 className="text-3xl font-black text-cyan-400 mt-1">{events.length}</h3>
// //           </div>
// //           <div className="bg-gradient-to-br from-slate-800/80 to-slate-900 p-5 rounded-2xl border border-slate-800 shadow-md">
...
//   // Roles default safety framework check 
//   // Naya user /register route se automatic 'MEMBER' bankar aayega
...
//     // Safety check fallback constraint on frontend
...
//         {/* 🔥 METRICS & COMMAND SYSTEM WITH CONDITIONAL RENDERING */}
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
//           <div className="bg-gradient-to-br from-slate-800/80 to-slate-900 p-5 rounded-2xl border border-slate-800 shadow-md">
//             <p className="text-xs text-slate-400 uppercase font-semibold tracking-wider">Total Tracked Events</p>
//             <h3 className="text-3xl font-black text-cyan-400 mt-1">{events.length}</h3>
...
//           {/* 🔐 CONTROL SYSTEM LOCK: Only visible to ADMIN & PHOTOGRAPHER */}
//           <div className="bg-gradient-to-br from-slate-800/80 to-slate-900 p-4 rounded-2xl border border-slate-800 shadow-md flex items-center">
...
//         {/* LIVE INJECTOR FORM (Doubly Protected block) */}
...
function Dashboard() {
  ...
  // ⚙️ CORE RENDERING PIPELINE: SEARCH, FILTER & MULTI-CRITERIA EVENT SORTING ENGINE
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* 🎛️ NEW: SORTING AND CONTROLS MANAGEMENT CONSOLE */}
